...
outputFile.write('unsuccessful, converted to str')
outputFile.close()
file.close()
...
for line in file:
    try:
        ...
        pass
outputFile=open('output.txt','a')
outputFile.write('redirect, converted to str')
outputFile.close()
file.close()
...
for i in requestedfiles:
    if requestedfiles[i] > max:
        ...
        maxfilename = i
outputFile=open('output.txt','a')
outputFile.write('maxfilename, converted to str')
outputFile.close()
...
for i in requestedfiles:
    if requestedfiles[i] < min:
        ...
        minfilename = i
outputFile=open('output.txt','a')
outputFile.write('minfilename, converted to str')
outputFile.close()
